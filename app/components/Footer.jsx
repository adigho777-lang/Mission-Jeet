    ...
    <footer style={{ background: '#0a0f1c', color: '#9ca3af' }}>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-[12px]">
            <li><Link href="#" className="hover:text-[#ff6a00]">JEE</Link></li>
            <li><Link href="#" className="hover:text-[#ff6a00]">NEET</Link></li>
          </ul>
        </div>
      ...
      {/* 🔥 BOTTOM BAR */}
      <div
        className="border-t text-center text-[11px] py-4"
